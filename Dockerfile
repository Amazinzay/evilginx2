...
WORKDIR /go/src/github.com/amazinzay/evilginx2

COPY Gopkg.toml Gopkg.lock ./

RUN dep ensure -vendor-only

COPY . /go/src/github.com/amazinzay/evilginx2
...
COPY --from=build /go/src/github.com/amazinzay/evilginx2/bin/evilginx /app/evilginx
